...
1. **Критический TCO инфраструктуры**: каждый из более 500 магазинов имеет собственный локальный сервер и платные лицензии на ПО (Windows Server, SQL), которые нужно обновлять и администрировать.
1. **Проблемы с оборудованием**: для разнородных платёжных терминалов в магазинах купленных сетей нужны уникальные драйверы, а это блокирует внедрение единых стандартов.
...
![Схема текущего ландшафта (AS-IS C4 Container Diagram)](c4-container.png)
